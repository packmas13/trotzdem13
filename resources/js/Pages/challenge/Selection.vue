<template>
    <app-layout current-route="app.team.index">
        ...
        <template #header v-else>
            ...
            <small>
                Du kannst dir die Projekte hier ansehen. Ein Projekt für dein
                Team auswählen dürfen jedoch nur die Leiter:innen der Teams.
            </small>
        </template>
                        ...
                        <ul>
                            ...
                            >
                                <ChallengeDetail :challenge="challenge">
                                    ...
                                    <template
                                        v-slot:actions
                                        v-if="canSelect(challenge)"
                                    >
                                        <div>
                                            <inertia-link
                                                :href="
                                                    route(
                                                        'app.challenge.select',
                                                        {
                                                            team_id: team.id,
                                                            challenge_id:
                                                                challenge.id,
    ...
    methods: {
        canSelect(challenge) {
            ...
            console.log(
                ...
                challenge.quantity > challenge.teams_count,
                challenge.quantity,
                challenge.teams_count
            );
